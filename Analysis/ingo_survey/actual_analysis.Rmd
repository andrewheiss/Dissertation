...
ggplot(df.strategies.funding, aes(x=Q3.8.num, y=num.strategies, group=Q3.8.num)) +
...
ggplot(df.strategies.collaboration, aes(x=num.collaborations, y=num.strategies, 
