...
```{r plot-govt-positivity-regime, fig.width=2, fig.height=2}
...
```{r plot-govt-positivity-issue, fig.width=2, fig.height=2}
...
```{r plot-familiarity-regime, fig.width=2, fig.height=2}
...
```{r plot-familiarity-issue, fig.width=2, fig.height=2}
...
```{r plot-frequency-regime, fig.width=2, fig.height=2}
...
```{r plot-registration-regime, fig.width=2, fig.height=2}
...
```{r plot-registration-issue, fig.width=2, fig.height=2}
...
dcjw <- read_feather(file.path(PROJHOME, "Data", 
...
```{r plot-restrictions-regime, fig.width=2, fig.height=2}
...
```{r plot-restrictions-issue, fig.width=2, fig.height=2}
