...
survey.countries.clean <- readRDS(file.path(PROJHOME, "Data", "data_processed", 
  ...
  mutate(Q4.11_collapsed = fct_collapse(Q4.11,
  ...
  mutate(Q4.13_collapsed = fct_collapse(Q4.13,
...
Most INGOs working in democracies are either moderately familiar with government regulations or not familiar at all. For INGOs working in autocracies, familiarity with regulations appears to be more essential—most are very or extremely familiar with regulations, and very few are unaware of any of the laws governing their activities. The difference in proportions across groups is significant. 
