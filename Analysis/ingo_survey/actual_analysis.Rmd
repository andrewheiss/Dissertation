...
caption <- "Differences in proportion of high and low contention INGOs reporting severity of gatekeeping regulations (accompanies @fig:regs-faced-gatekeeping). Posterior probability that the proportion is greater than 0 given in parentheses. {#tbl:regs-differences-p}"
...
cat(clean.table)
cat(clean.table, file=file.path(PROJHOME, "Output", "tables", 
                                "3-regs-differences-gatekeeping-p.md"))
```

```{r regs.differences.capture, results="asis"}
caption <- "Differences in proportion of high and low contention INGOs reporting severity of program capture regulations (accompanies @fig:regs-faced-capture). Posterior probability that the proportion is greater than 0 given in parentheses. {#tbl:regs-differences-p}"
clean.table <- pandoc.table.return(filter(regs.differences.table.p, 
                                          !(` ` %in% gatekeeping.regs)),
                                   keep.line.breaks=TRUE,
                                   justify="lccc", caption=caption)
...
cat(clean.table)
cat(clean.table, file=file.path(PROJHOME, "Output", "tables", 
                                "3-regs-differences-capture-p.md"))
```
