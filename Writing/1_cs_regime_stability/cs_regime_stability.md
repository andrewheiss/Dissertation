...
![Average proporition and intensity of conflictual events](../../Output/figures/1-events-both.pdf){#fig:events-both}
...
When not controlling for any other factors, interstate shaming (as measured by the percent of all reported events that are categorized as either conflictual) appears to have a powerful relationship with civil society regulations. Higher proportions of conflictual interactions are negatively associated with the CSRE—at first glance, more shaming leads to more restrictions in both autocracies and democracies. 
